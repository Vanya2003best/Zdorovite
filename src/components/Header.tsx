      ...
      >
        <div className="mx-auto flex h-16 max-w-[1200px] items-center gap-5 px-4 sm:px-6">
          ...
          <div className="hidden sm:flex items-center gap-1">
            {user ? (
              <>
                {/* No bell here — there's no standalone notifications page.
                    The real DB-backed NotificationsBell lives in
                    AccountTopBar / StudioTopBar. */}
                <Link
                  href="/?fav=1"
          ...
          <MobileMenu isLoggedIn={!!user} displayName={displayName} />
        </div>
      </header>
    </AutoHideHeader>
  );
