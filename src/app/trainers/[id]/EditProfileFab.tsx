...
/**
 * Floating "Edit profile" button visible only to the profile owner
 * when they're viewing their own public page WITHOUT ?edit=1.
 * Clicking it enters edit mode.
 */
export default function EditProfileFab({ slug }: { slug: string }) {
  return (
    <Link
      href={`/trainers/${slug}?edit=1`}
